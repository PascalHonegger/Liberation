...
public class ReactionCollectionEditor : EditorWithSubEditors<ReactionEditor, Reaction>
{
	...
	private SerializedProperty onlyReactOnceProperty;           // Represents the bool for OnlyReactOnce.
	...
	private const string onlyReactOncePropName = "onlyReactOnce";   // Name of the field for the array of Reactions.
	...
	private void OnEnable()
	{
		...
		onlyReactOnceProperty = serializedObject.FindProperty(onlyReactOncePropName);
	...
	public override void OnInspectorGUI()
	{
		...
		// Toogle button for the OnlyReactOnce property
		onlyReactOnceProperty.boolValue = EditorGUILayout.ToggleLeft(new GUIContent("Only react once"), onlyReactOnceProperty.boolValue);
